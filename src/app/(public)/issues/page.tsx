...
export default function AllIssuesPage() {
  ...
  // ✅ derive view from URL during render (prevents hydration mismatch)
      ...
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-white/60">Filter and sort with List and Board views.</p>
          </div>

          <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
            {/* Premium toggle (List then Board) */}
            <div className="flex h-11 rounded-2xl border border-[color:rgba(38,198,255,0.22)] bg-[linear-gradient(135deg,rgba(38,198,255,0.08),rgba(0,0,0,0))] p-1 shadow-[0_0_0_1px_rgba(255,255,255,0.03)_inset]">
              <button
                onClick={() => go("list")}
                className={[
                  "h-9 rounded-xl px-4 text-sm font-extrabold transition",
                  viewFromUrl === "list"
                    ? "border border-[color:rgba(38,198,255,0.35)] bg-[color:rgba(38,198,255,0.18)] text-white shadow-[0_10px_30px_rgba(38,198,255,0.12)]"
